...
public class LunchMenuTestData {
    ...
    public static final int LUNCH_MENU_GINZA_ID = LUNCH_MENU_SEQ_START;
    ...
    public static LocalDate LUNCH_MENU_GINZA_DATE_NEW = LocalDate.of(2055, 11, 12);
    ...
    public static LunchMenu createNewGinzaMenuToday() {
        return new LunchMenu(null, RESTAURANT_GINZA, LUNCH_MENU_GINZA_DATE_NEW);
    }
}
